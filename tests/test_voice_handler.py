...
from beacon.voice_handler import briefing_handler, fulfillment_handler
...
class TestBriefingHandler:
    def test_returns_rca_summary(
        ...
        mocker.patch("beacon.store.get_incident", return_value=sample_incident)
...
class TestFulfillmentHandler:
    ...
    def test_handles_missing_incident(
        ...
        mocker.patch("beacon.store.get_incident", return_value={})
