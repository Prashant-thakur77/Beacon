...
*Draft for AWS Builder Center. ~1200 words. Screenshots to add: the Night Board with a fix awaiting approval; the Step Functions graph mid-loop; the IAM policy with both security-group statements; the Contracts card with the quoted grant.*
