...
def parse_event(event: dict[str, Any], config: BeaconConfig) -> TriggerInfo:
...
def _parse_alarm_event(event: dict[str, Any], config: BeaconConfig) -> TriggerInfo:
...
def _parse_schedule_event(config: BeaconConfig) -> TriggerInfo:
