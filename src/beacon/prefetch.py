...
def _load_prefetch_prompt() -> str:
    ...
    resource = files("beacon").joinpath("prompts/prefetch.txt")
...
def plan(analysis: str, trigger: TriggerInfo, config: BeaconConfig) -> dict[str, Any]:
...
def execute(prefetch_plan: dict[str, Any], config: BeaconConfig) -> dict[str, Any]:
